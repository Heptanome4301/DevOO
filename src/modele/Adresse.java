...
public class Adresse extends Observable {
	...
	private int id;
        /**
         * Sa coordonn�e suivant l'axe Est/Ouest. Utile pour la repr�sentation graphique de cette adresse dans un plan.
         */
	private int x;
        /**
         * Sa coordonn�e suivant l'axe Nord/Sud. Utile pour la repr�sentation graphique de cette adresse dans un plan.
         */
	private int y;
        /**
