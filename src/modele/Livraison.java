...
/**
 * Cette classe repr�sente � la fois une demande de livraison sur une adresse et la livraison qui sera effectu�e.
 */
public class Livraison {
	...
	private int id;
        /**
         * Bool�en positionn� lors du calcul de l'heure effective de passage : si true, l'horaire de livraison
         * est en dehors de la fen�tre de livraison.
         */
	...
	/**
	 * Constructeur de la classe Livraison. L'horaire de livraison et le retard ne sont pas positionn�s par
         * le constructeur.
	 * 
	 * @param id l'id de la livraison.
	 * @param adresse l'adresse de livraison.
	 * @param fenetreLivraison la fen�tre de livraison d�sir�e.
	 */
	public Livraison(int id, Adresse adresse, FenetreLivraison fenetreLivraison) {
         ...
         * @return true si l'adresse de livraison, la fen�tre de livraison ainsi que l'id est identique.
         */
	@Override
	...
	public FenetreLivraison getFenetreLivraison() {
        ...
        /**
         * Mutateur de l'attribut horaire. Cette m�thode est appel�e lors du calcul de la tourn�e et de la mise
         * � jour de la tourn�e.
         * @param horaire l'horaire � �tablir en tant qu'heure de passage.
         */
	public void setHoraire(Date horaire) {
         ...
         * @return true si la livraison sera en retard par rapport � l'horaire d�sir�.
         */
	public boolean isRetard() {
        ...
        /**
         * Calcul du bool�en isRetard : si l'horaire de livraison pr�vu est hors de la fen�tre de livraison
         * alors ce boolen est �tabli � true.
         */
