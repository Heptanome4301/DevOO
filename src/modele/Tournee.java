...
public class Tournee extends Observable {
	...
	/**
	 * Une tournée contient la liste des livraisons non ordonnée. Elle stocke
	 * également l'itinéraire de la tournée (une liste de chemins) L'instance de
	 * tournée est créée par la classe Plan, au chargement du fichier des
	 * livraisons. La tournée est accessible par le contrôleur
	 */
	...
	/**
	 * Génère les suites des instructions que le livreur doit suivre pour
	 * effectuer sa tournée
	 * 
	 * @throws Exception
	 *             si échec de création du fichier de sortie (soit le path n'est
	 *             pas valide, ou que le calcul de la tournée n'est pas fait) si
	 *             un appel à calculerTournee n'est pas fait auparavant le
	 *             fichier ne sera pas créé et une exception est levée
	 */
	...
	/**
	 * Applée par this.calculerTournee Construction du graphe qui represente le
	 * cout des chemins entre chaque couple de livraison à effectuer Pour se
	 * faire des appels à plan.calculerChemin sont effectués Ce graphe sera
	 * passé comme parametre à la classe TSP i,j : le cout du chemin entre
	 * l'adresse de id i et l'adresse de l'id j
	 * 
	 * @return un tableau de 2 dimensions representant les adresse de livraison
	 */
	...
	/**
	 * pour une fentre donneé Calcule la tournée qui passera par toutes les
	 * livraisons Cette methode fait appel entre autre à construireGraphe() puis
	 * TSP.chercherSolution Le resultat est obtenue en faisant TSP.getSolution()
	 * ce resultat est "convertie" en chemin: faire appel à
	 * plan.calculerChemin() Enfin il est stocké dans l'attribut chemins, et
	 * accessible avec getIteneraire()
	 * 
	 * @return
	 */
	...
	/**
	 * Acces à la liste des livraisons à effecteur (pour les afficher dans vue
	 * par exemple)
	 * 
	...
	/**
	 * Modification de la tournée en lui ajoutant une nouvelle livraison telle
	 * quelle précède lFollow Si les deux livraisons sont égales, ajoute la
	 * livraison en fin de tournée
	 * 
	 * @param lAdd
	 * @param lFollow
	 */
	...
	/**
	 * Echange l'ordre de passage de deux livraisons et racalcule les heures de
	 * passages Ne fait rien si les deux livraisons sont les mêmes
	 * 
	 * @param l1
	 * @param l2
	 */
