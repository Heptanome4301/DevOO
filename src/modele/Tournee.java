...
public class Tournee extends Observable implements Visitable {
	/**
	 * Le plan de la ville n�cessaire au calcul des chemins entre les
	 * diff�rentes livraisons.
	 */
	private Plan plan;
	/**
	...
	/**
	 * Le constructeur de la tourn�e. La dur�e et les chemins seront calcul�s
	 * par la suite.
	 * 
	 * @param plan
	 *            Le plan de la ville.
	 * @param livraisons
	 *            La liste des livraisons � traiter.
	 * @param fenetresLivraison
	 *            La liste des fen�tres associ�es � chaque livraison.
	 * @param entrepot
	 *            l'adresse de l'entrepot.
	 */
	 ...
	 * 
	 * @param fenetresLivraison
	 *            la liste des fen�tres � trier.
	 * @return la liste tri�e.
	 */
	private ArrayList<FenetreLivraison> sortFenetreLivraison(
			ArrayList<FenetreLivraison> collection) {
	 ...
	 * 
	 * @return la liste des chemins qui composent la tourn�e, null si le calcul
	 *         n'a pas encore �t� r�alis�.
	 */
	...
	/**
	 * G�n�re les instructions de circulation � fournir au livreur pour qu'il
	 * effectue la tourn�e en empruntant les plus courts chemins.
	 * 
	 * @param fichier
	 *            le fichier dans lequel �crire ces instructions.
	 * @throws Exception
	 *             Si un probl�me survient � l'ouverture ou � l'�criture du
	 *             fichier.
	 */
	...
	/**
	 * Construit le graphe des plus courts chemins entre chaque adresse de
	 * livraison.
	 * 
	 * @param cheminsDuGraphe
	 *            une matrice des chemins � ajouter au graphe.
	...
	/**
	 * Recup�re un chemin dans la liste dont l'adresse d'arriv�e est celle
	 * pass�e en param�tre de cette m�thode.
	 * 
	 * @param arrivee
	 *            l'adresse d'arriv�e du chemin recherch�.
	...
	/**
	 * Recup�re un chemin dans la listedont l'adresse de d�part est celle pass�e
	 * en param�tre de cette m�thode
	 * 
	 * @param depart
	 *            l'adresse de d�part du chemin recherch�.
	...
	/**
	 * R�cup�re les livraisons associ�es � une fen�tre de livraison pass�e en
	 * param�tre.
	 * 
	 * @param fenetreLivraison
	 *            la fen�tre de livraison.
	...
	/**
	 * Construit une matrice de Chemins (les plus courts chemins) entre chaque
	 * adresse associ�es � la fen�tre de livraison pass�e en param�tre.
	 * 
	 * @param fenetreLivraison
	 *            la fen�tre de livraison que l'on souhaite traiter.
	 * @param adrssDepart
	 *            une adresse suppl�mentaire (soit l'entrepot pour la premi�re
	 *            fen�tre soit la derni�re livraison effectu�e lors de la
	 *            fen�tre pr�c�dente.
	 * @return mat la matrice des plus courts chemins. mat[i][j] est le plus
	 *         court chemin reliant la i-�me adresse de livraison � la j-�me.
	 */
	...
	/**
	 * Calcule la tourn�e, c'est � dire le moyen le plus rapide d'effectuer
	 * toutes les livraisons en respectant au maximum les contraintes horaires
	 * des fen�tres de livraison. Cette m�thode stock le r�sultat (la liste des
	 * chemins) dans l'attribut chemin, et met � jour l'attribut dur�e en
	 * cons�quence.
	 */
	public void calculerTournee() { // todo prévoir que les profs peuvent être
									// des trolls : cul de sac
	...
	/**
	 * Cette m�thode met � jour les heures de livraisons pr�vues pour toutes les
	 * livraisons suivant la i-�me � partir du temps de parcours calcul�.
	 * 
	 * @param indiceDepart
	 *            l'indice de la livraison � partir de laquelle on veut mettre �
	 *            jour les horaires de livraison.
	 */
	...
	/**
	 * Cette m�thode calcule une nouvelle date � partir de celle pass�e en
	 * param�tre � laquelle elle ajoute un nombre de secondes �gal au deuxi�me
	 * param�tre.
	 * 
	 * @param horaire
	 *            la date originale.
	 * @param seconds
	 *            le nombre de secondes � ajouter.
	...
	/**
	 * Cette m�thode calcule un morceau de la tourn�e associ� � une fen�tre de
	 * livraison.
	 * 
	 ...
	 * 
	 * @param livraisons
	 *            la nouvelle liste de livraisons � traiter.
	 */
	...
	/**
	 * Ajoute la livraison lAdd � la tourn�ee, juste avant la livraison lFollow.
	 * Si lFollow n'est pas dans la liste, lAdd est ajout� � la fin de la
	 * tourn�e. La liste des chemins est mis � jour.
	 * 
	 * @param lAdd
	 *            la livraison � ajouter.
	 * @param lFollow
	 *            la livraison avant laquelle ajouter lAdd.
	 */
	...
	/**
	 * Echange l'ordre de passage de deux livraisons et recalcule les heures de
	 * passage Ne fait rien si les deux livraisons sont les m�mes
	 * 
	 * @param l1
	 *            la premi�re livraison.
	 * @param l2
	 *            la seconde livraison.
	 */
	public void echangerLivraison(Livraison l1, Livraison l2) {
		if (livraisons.contains(l1) && livraisons.contains(l2)
				&& !l1.equals(l2)) {
	...
	/**
	 * Cette m�thode r�cup�re la livraison suivant celle pass�e en param�tre
	 * dans la liste des livraisons qui composent la tourn�e.
	 * 
	 * @param livraison
	...
	/**
	 * Cette m�thode permet de r�cup�rer la i-�me fen�tre de livraison de
	 * l'attribut fenetreLivraison.
	 * 
	 * @param index
	...
	/**
	 * Cette l�thode v�rifie si le tron�on t pass� en param�tre est emprunt�
	 * lors de la tourn�e.
	 * 
	 * @param t
